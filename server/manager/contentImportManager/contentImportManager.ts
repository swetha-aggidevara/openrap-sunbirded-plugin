...
import { IContentImport, ImportStatus, ImportSteps, handelError, ErrorObj } from "./IContentImport"
...
export class ContentImportManager {
  ...
  public async initialize(plgId, contentFilesPath, downloadsFolderPath) {
    pluginId = plgId;
