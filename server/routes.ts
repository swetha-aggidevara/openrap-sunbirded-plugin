...
export class Router {
  ...
  public init(app: any, manifest: Manifest, auth?: any) {
    ...
    app.post("/api/telemetry/v1/update/config", telemetry.setTelemetryConfigSyncToServer.bind(telemetry));
    app.post("/api/telemetry/v1/info", telemetry.getTelemetryConfigSyncToServer.bind(telemetry));
